...
<body>
    ...
    <div class="container mt-3">
        ...
        <form id="postForm">
        <textarea class="form-control" name="bodypost" placeholder="Вы можете написать свою историю" cols="30" rows="10"></textarea>
        <button type="submit" id="createpost" class="btn btn-primary mb-3 mt-3">Опубликовать</button>
        </form>
