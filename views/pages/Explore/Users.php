        ...
        <h2>Исследовать людей</h2>
            ...
            foreach ($users as $u) {
                ...
                <div class="card-body">
                    ...
                    <h5 style="margin-bottom: -0px;" href="testings" class="col-sm-10 d-inline-block font-weight-bold"><a href="/'.$u['username'].'">'.$u['fname'].'&nbsp;'.$u['lname'].'</a><br><p href="testings" style="font-size: 15px; font-weight: 500; margin-top: -45px;" class="col-10 d-inline-block font-weight-bold"></p></h5>
